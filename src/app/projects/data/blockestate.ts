...
export default {
  ...
  images: [
    `${blockestateBaseUrl}/blockestate1.avif`,
    `${blockestateBaseUrl}/blockestate2.avif`,
    `${blockestateBaseUrl}/blockestate3.avif`,
    `${blockestateBaseUrl}/blockestate4.avif`,
    `${blockestateBaseUrl}/blockestate5.avif`,
    `${blockestateBaseUrl}/blockestate6.avif`,
  ],
};
