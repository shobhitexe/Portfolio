...
export default {
  ...
  images: [
    `${sleekcustomImageBaseUrl}/sleekcustom1.avif`,
    `${sleekcustomImageBaseUrl}/sleekcustom2.avif`,
    `${sleekcustomImageBaseUrl}/sleekcustom3.avif`,
    `${sleekcustomImageBaseUrl}/sleekcustom4.avif`,
    `${sleekcustomImageBaseUrl}/sleekcustom5.avif`,
    `${sleekcustomImageBaseUrl}/sleekcustom6.avif`,
  ],
};
