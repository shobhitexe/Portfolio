...
export const headingParagraph1: string = `Hello, I'm Shobhit, a dedicated developer based in India. I take pride in crafting exceptional projects. My expertise
